...
int main( )
{
    ...
    // Load models
    Model dog((char*)"Models/RedDog.obj"); //carga del modelo
    Model cat((char*)"Models/miGato.obj"); //carga del modelo del gato
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //---------------Perro2--------------------------------------
        model = glm::mat4(1.0f);
        model = glm::translate(model, glm::vec3(-0.5f, -0.4f, 1.5f));
