...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//-----------------------------------------------------------------------------------------------
		//Model dedo1
		model = glm::translate(modelTemp, glm::vec3(0.25f, 0.3f, -0.35f));
		...
		model = glm::rotate(model, glm::radians(dedo1FB), glm::vec3(0.0f, 0.0, 1.0f)); //dedo1FB
		...
		//Model dedo2FB
		model = glm::translate(modelTemp2, glm::vec3(0.3f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(dedo2FB), glm::vec3(0.0f, 0.0, 1.0f)); //dedo2FB
		modelTemp2 = model = glm::translate(model, glm::vec3(0.2f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.4f, 0.2f, 0.2f));
		color = glm::vec3(1.0f, 0.5f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		// Model dedo3FB
		model = glm::translate(modelTemp2, glm::vec3(0.3f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(dedo3FB), glm::vec3(0.0f, 0.0, 1.0f)); //dedo3FB
		modelTemp2 = model = glm::translate(model, glm::vec3(0.2f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.4f, 0.2f, 0.2f));
		color = glm::vec3(1.0f, 0.5f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
